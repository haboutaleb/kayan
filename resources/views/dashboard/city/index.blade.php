...
<div class="panel panel-flat tb_padd">
    ...
    <a class="btn btn-primary" href="{{ route('city_create') }}"> {{ trans('dash.add_new_city') }} </a>
    ...
    <table class="table table-condensed table-hover datatable-highlight">
        <thead>
            <tr>
                ...
                <th class="text-center"> {{ trans('dash.zip_code') }} </th>
        ...
        <tbody>
            ...
            <tr id="row_{{ $city->id }}">
                ...
                <td class="text-center">
                    <a href="{{ route('city_edit',['id' => $city->id ]) }}" class="btn btn-primary"> <i class="icon-pencil3"></i> </a>
                    <a onclick="sweet_delete( ' {{ route('city_delete').'/'.$city->id }} ' , '{{ trans('dash.deleted_msg_confirm') }}' ,{{ $city->id }} )" class="btn btn-danger" > <i class="icon-database-remove"></i> </a>
                </td>
            </tr>
