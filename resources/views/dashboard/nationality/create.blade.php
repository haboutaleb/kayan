...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <!-- Basic layout-->
            <form action="{{ route('nationality_store') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                {{ Form::token() }}
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title"> {{ trans('dash.create_new_nationalities') }} </h5>
