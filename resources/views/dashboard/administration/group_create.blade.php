...
<div class="row">
    <div class="col-md-12">
        ...
        <!-- Basic layout-->
        <form action="{{ route('administration_group_store') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
            {{ Form::token() }}
            <div class="panel panel-flat">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <textarea class="form-control" name="short_desc_ar" placeholder="{{ trans('dash.short_desc_ar') }}"></textarea>
                        </div>
                    </div>
								...
								<div class="form-group">
									...
									<div class="col-lg-9">
										<div class="checkbox checkbox-switchery switchery-xs">
											<label>
												<input type="checkbox" name="perms[]" class="switchery" value="cities" >
											</label>
										</div>
									</div>
								</div>
                            ...
                            <div class="col-lg-3">
								<div class="form-group">
									...
									<div class="col-lg-9">
										<div class="checkbox checkbox-switchery switchery-xs">
											<label>
												<input type="checkbox" name="perms[]" class="switchery" value="city_create" >
											</label>
										</div>
									</div>
								</div>
                            ...
                            <div class="col-lg-3">
								<div class="form-group">
									...
									<div class="col-lg-9">
										<div class="checkbox checkbox-switchery switchery-xs">
											<label>
												<input type="checkbox" name="perms[]" class="switchery" value="city_edit" >
											</label>
										</div>
									</div>
								</div>
                            ...
                            <div class="col-lg-3">
								<div class="form-group">
									...
									<div class="col-lg-9">
										<div class="checkbox checkbox-switchery switchery-xs">
											<label>
												<input type="checkbox" name="perms[]" class="switchery" value="city_delete" >
											</label>
										</div>
									</div>
								</div>
