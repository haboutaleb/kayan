...
<div class="row">
    <div class="col-md-6">
        ...
        <!-- Basic layout-->
        <form action="{{ route('bank_account_store') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
            {{ Form::token() }}
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title"> {{ trans('dash.add_new_bank_account') }} </h5>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control" name="bank_name" placeholder="{{ trans('dash.bank_name') }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control" name="benif_name" placeholder="{{ trans('dash.benift_name') }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control" name="account_number" placeholder="{{ trans('dash.account_number') }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control" name="ipan_number" placeholder="{{ trans('dash.ipan_number') }}" required>
                        </div>
                    </div>
