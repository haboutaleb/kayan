...
@section('content')
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <!-- Basic layout-->
            <form action="{{ route('review_store') }}" class="form-horizontal" method="post" enctype="multipart/form-data">
                {{ Form::token() }}
        ...
        <div class="col-md-6">
            <div class="panel panel-flat">
                ...
                <div class="panel-heading">
                    <h5 class="panel-title"> {{ trans('dash.latest_review') }} </h5>
